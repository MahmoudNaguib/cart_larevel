        ...
        <table class="table display responsive nowrap">
            <thead>
                <tr>
                    ...
                    <th class="wd-10p">{{trans('app.Code')}} </th>
                    <th class="wd-10p">{{trans('app.Amount')}} </th>
                    <th class="wd-10p">{{trans('app.Expiry date')}} </th>
                    <th class="wd-10p">{{trans('app.Max Usage')}} </th>
                    <th class="wd-10p">{{trans('app.Used times')}} </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="center">{{$row->amount}} {{$row->currency->iso}}</td>
