@include('form.select',['name'=>'category_id','options'=>$row->getSections(),'attributes'=>['class'=>'form-control','label'=>trans('app.Select section'),'placeholder'=>trans('app.Select section'),'required'=>1]])
