...
<div class="section-wrapper">
    ...
    <div class="table-responsive">
        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered pull-left">
            <tr>
                <td width="25%" class="align-left">{{trans('app.Category')}}</td>
            ...
            @endforeach
            <tr>
                <td width="25%" class="align-left">{{trans('app.Unit Price')}}</td>
                <td width="75%" class="align-left">{{$row->unit_price}} {{trans('app.EGP')}}</td>
            </tr>
            <tr>
                <td width="25%" class="align-left">{{trans('app.Discount')}}</td>
                <td width="75%" class="align-left">{{$row->discount}} {{trans('app.EGP')}}</td>
            </tr>
            <tr>
