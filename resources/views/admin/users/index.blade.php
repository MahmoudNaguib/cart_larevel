        ...
        <table class="table display responsive nowrap">
            <thead>
                <tr>
                    ...
                    <th class="wd-15p">{{trans('app.Role')}} </th>
                    <th class="wd-15p">{{trans('app.Name')}} </th>
                    <th class="wd-15p">{{trans('app.Email')}} </th>
                    <th class="wd-15p">{{trans('app.Mobile')}} </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="center">{{($row->role->title)?:trans('app.Guest')}}</td>
